...
public static String chatGPT(String message) {
    ...
    String apiKey = "sk-proj-HMqhnp69bV0Dqk1TW9QlT3BlbkFJTvZVw2RtJ3srThJgR46t";
...
<%
String movie1 = "spider-Man 3";
String movie2 = "The Great Gatsby";
String movie3 = "Titanic";

String rating1 = " (rating: 4/5), ";
String rating2 = " (rating: 2/5), ";
String rating3 = " (rating: 5/5), ";

String query = "Please recommend a movie based on the following movies and the rating I gave them out of 5: ";


String description = fixIt(chatGPT(query + movie1 + rating1 + movie2 + rating2 + movie3 + rating3));
